...
@section('content')
    ...
    {!! Form::open() !!}
        ...
        @include('partials/roles', ['roles' => json_decode($shift->roles), 'help' => "By default, roles will be inherited from the department. You can use these options to override the default."])
