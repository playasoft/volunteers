...
@section('content')
    ...
    {!! Form::open() !!}
        ...
        @include('partials/form/password', ['name' => 'password', 'label' => 'Password', 'placeholder' => 'Your current password', 'help' => "In order to change your username or email, you must provide your password."])
    ...
    {!! Form::open() !!}
        ...
        @include('partials/form/text', ['name' => 'burner_name', 'label' => 'Burner Name', 'placeholder' => 'Your name on the Playa'])
        @include('partials/form/text', ['name' => 'real_name', 'label' => 'Real Name', 'placeholder' => 'Your name in the Default World'])
        @include('partials/form/date', ['name' => 'birthday', 'label' => 'Birthday', 'placeholder' => 'When were you born?'])
