...
@section('content')
    ...
    {!! Form::open() !!}
        ...
        @include('partials/form/text', ['name' => 'burner_name', 'label' => 'Burner Name', 'placeholder' => 'Your name on the Playa', 'value' => $user->data->burner_name])
        @include('partials/form/text', ['name' => 'real_name', 'label' => 'Real Name', 'placeholder' => 'Your name in the Default World', 'value' => $user->data->real_name])
        @include('partials/form/date', ['name' => 'birthday', 'label' => 'Birthday', 'placeholder' => 'When were you born?', 'value' => $user->data->birthday])
