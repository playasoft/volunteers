...
3. Run ```cp .env.example .env```, and copy and paste the key you generated into the new ***.env*** file. Set your SITE_NAME, SITE_URL, DB_PASSWORD, and any other variables you require.
